...
type protocolFunc = func() *cosi.ObjectProtocol
...
func New(platform string) *Client {
	...
	case consts.AzureKey:
		...
		proto = func() *cosi.ObjectProtocol {
			return &cosi.ObjectProtocol{
				Type: cosi.ObjectProtocol_AZURE,
			}
		}
...
// S3Endpoint returns the fake S3 endpoint.
func (c *Client) S3Endpoint() string { return "http://fake-s3:8080" }

// S3Region returns the fake S3 region.
func (c *Client) S3Region() string { return "fake-region" }
